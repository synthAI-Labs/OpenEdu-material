JavaScript: Manipulating DOM Object
...
Check the requirement of this project from both images(jpg and gif). All the data and CSS has been implemented using JavaScript only. The data is found on starter folder project*3. The drop down button has been created using [\_details*](https://www.w3schools.com/tags/tag_details.asp) HTML element.
